            ...
            <div className="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
              <ul className="navbar-nav">
                <li className="nav-item">
                  <a className="nav-link" href="index.html"> <img src={resume.database[0].logo} alt="logo" /> </a>
                </li>
              </ul>
            </div>
          </nav>
  ...
  <section className="trending_items">
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div>
          <a href={resume.database[4].item[6].url} className="btn_8">{resume.database[4].item[6].btn}</a>
        </div>
      </div>
    </div>
  </section>
